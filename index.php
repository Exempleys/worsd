        ...
        <div id="carouselExampleIndicators1" class="carousel slide my-4" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="d-block img" src="layout/img/1190.png" alt="First slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block img" src="layout/img/2222.png" alt="Second slide">
                </div>
                <div class="carousel-item">
                    <img class="d-block img" src="layout/img/4.png" alt="Third slide">
                </div>
            </div>
                ...
                echo'" method="POST">';
                    echo'<div class="card h-100">';
                        ...
                        echo'<div class="card-body bg-light">';
                            ...
                            echo "<input type='submit' name='add_cart' class='btn btn-success' value='ajouter dans le panier'>";
                        echo'</div>
                        </div>
                    </div>';
             echo'</form>';
